...
class ResponseJSONController {
    ...
    def LOGGER = LoggerFactory.getLogger(ResponseJSONController.class)          // Logger to log the errors and exceptions
    ...
    def getWeatherByCityAndCountry(){
        LOGGER.debug("The action of getting weather via a city name and country code")
        try{
