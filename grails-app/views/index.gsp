        ...
        <div class="container form-group">
            <g:form controller="ResponseJSON" action="getWeatherByCityAndCountry">
                ...
                <div class="input-group mb-3">
                    <g:field type="text" name="cityName" class="typeahead form-control" style="margin-left: 260px" id="city" aria-describedby="emailHelp" placeholder="${message(default: 'Enter the name of the city', code: 'message.entercityname')}" required="required" autocomplete="off"/><br>
